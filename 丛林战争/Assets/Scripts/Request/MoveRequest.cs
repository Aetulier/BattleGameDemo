...
public class MoveRequest : BaseRequest {
    ...
    {
        SendRequset(localPlayerTransform.position.x, localPlayerTransform.position.y, localPlayerTransform.position.z,
    ...
    private  void SendRequset(float x, float y, float z, float rotationX, float rotationY, float rotationZ, float forward)
    {
